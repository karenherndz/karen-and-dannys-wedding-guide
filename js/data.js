...
const WEDDING_DATA = {
  ...
  "family": {
    "karen": {
      "dad": "Jose N. Hernandez",
      "mom": "Posthumously Honored",
      "brother": "Jose D. Hernandez"
    },
    "danny": {
      "mom": "Cindy Milojevic",
    ...
    "extended": {
      "peggy": "Assists Karen and girls",
      "marilyn": "Assists men with boutonnieres",
      "lauren": "Family",
      "dave": "Family",
      "milo": "Family",
      "remy": "Family",
  ...
  "vendors": [
    ...
    },
    {
      ...
      "status": "booked",
      "notes": "Make & install banners, draping. Sets up banners at Friday rehearsal. Deposit paid by Jose N. Remainder due 4/11/26."
    },
    {
    ...
    },
    {
      ...
      "arrivalTime": "",
      "status": "booked",
      "notes": "Playing at No Dice. Deposit paid by Papa (Jose N.). Remainder due 4/11/26."
    },
    {
      "role": "Tailor / Dress",
      "name": "Sophie Tran",
  ...
  "ceremony": {
    ...
    "processional": [
      ...
      "Lauren Langenmayr and Jose D. come down the aisle",
      "Ring Bearers enter",
      "Bride's processional music begins",
      "Karen enters with her father Jose N. Hernandez",
    ...
    "recessionalOrder": [
      ...
      "Lauren Langenmayr and Jose D. process",
      "Cindy, Duschan, and Jose N. process",
      "Flower girls guide the rest of the guests"
    ],
    "notes": "Jose N. walks Karen down the aisle and takes his seat. Kali says 'You may all be seated' and begins the ceremony. Jeanne holds latecomers until ceremony is over."
  },

  "speeches": {
    "order": [
      { "speaker": "Jose N. Hernandez (Karen's Dad)", "time": "3 minutes" },
      { "speaker": "Cindy & Duschan Milojevic (Danny's Parents)", "time": "3 minutes" },
      { "speaker": "Jose D. Hernandez (Best Man)", "time": "5 minutes" },
  ...
  "todos": [
    ...
    { "task": "Ask Sam Kuslan about blocking wedding dates", "assignee": "", "due": "", "status": "not started", "priority": "high" },
  ...
  "timeline": {
    "friday": [
      { "time": "1:00 - 3:00 PM", "event": "Rehearsal", "location": "Industrial Gardens", "who": "Wedding party, Jeanne, Antonia (1pm for setup), Khristian (plants), Cindy, Duschan, Jose N., Jose D., Lauren, Dave, Milo, Remy, Amanda, Doug, Ellison, Kali, Elizabeth", "notes": "Walk through ceremony and room flip. Antonia arrives at 1pm to set up banners/decor. Khristian drops off plants. Give Jeanne all items for next day." },
      { "time": "3:30 PM", "event": "Key members back at Milo Gardens", "location": "Milo Gardens", "who": "Cindy, Duschan, Jose N., Jose D., Lauren, Dave, Milo, Remy, Amanda, Doug, Ellison, Kali, Elizabeth" },
    ...
    "saturday": [
      ...
      { "time": "12:00 PM", "event": "Antonia & YUR Rentals arrive", "location": "Industrial Gardens", "who": "Antonia, YUR Rentals", "notes": "Decor/draping setup and furniture delivery" },
      ...
      { "time": "1:00 PM", "event": "Vendors & Crew Arrive", "location": "Industrial Gardens", "who": "Jeanne, Lady B, Jenny and any girls that want to help decorate tables", "notes": "Jeanne sets up seating chart & oversees. DJ sets up sound." },
      ...
      { "time": "2:00 PM", "event": "Photo team & Sam Kuslan arrive", "location": "Greatman Cottage / Industrial Gardens", "who": "Karen, Danny, Photographer, Sam Kuslan", "notes": "First look & beauty shots at Greatman Cottage. Sam sets up piano at venue." },
      ...
      { "time": "2:30 - 3:15 PM", "event": "Touch-ups & hang out", "location": "Conference room", "who": "Karen, Danny, Cindy, Duschan, Jose N., Jose D., Lauren", "notes": "Away from guests" },
      ...
      { "time": "4:00 - 4:30 PM", "event": "Room Flip & Cocktail Hour", "location": "Industrial Gardens", "who": "Zach, Joey, John, Gabriel + any guys, Family, Photographer", "notes": "High tops stocked with champagne glasses. Courtyard bar open. Guests hang out in street, balcony, or conference room while guy cousins move 7 tables. Bar in ceremony space sets up during flip. Family photos happening simultaneously." },
      { "time": "5:00 - 6:30 PM", "event": "Dinner & Buffet", "location": "Industrial Gardens", "who": "Everyone", "notes": "DJ plays Karen & Danny's playlist." },
      { "time": "6:15 PM", "event": "Speeches", "location": "Industrial Gardens", "who": "Jose N., Cindy, Duschan, Jose D., Lauren", "notes": "After everyone has their meal." },
  ...
  "budget": {
    ...
    "expenses": [
      ...
      { "item": "Stationary & Invites", "total": 600, "deposit": 600, "paid": true, "remainder": 0, "dueDate": "N/A", "whoPaid": "Jose N." },
      { "item": "Bartenders (Branson)", "total": 750, "deposit": 300, "paid": true, "remainder": 450, "dueDate": null, "whoPaid": "Jose N." },
      ...
      { "item": "Antonia's Decorating Setup", "total": 1650, "deposit": 825, "paid": true, "remainder": 825, "dueDate": "4/11/26", "whoPaid": "Jose N." },
      ...
      { "item": "After Party Live Band (Thomas Glass)", "total": 3000, "deposit": 1300, "paid": true, "remainder": 1700, "dueDate": "4/11/26", "whoPaid": "Papa (Jose N.)" }
    ],
    "tbd": [
      "Danny's Suit",
      "After Party DJ",
