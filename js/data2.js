...
const WEDDING_DATA = {
  ...
  "timeline": {
    "friday": [
      { "time": "1:00 - 3:00 PM", "event": "Rehearsal", "location": "Industrial Gardens", "who": "Wedding party, Jeanne (1pm), Antonia (1pm for setup), Khristian (plants), Cindy, Duschan, Jose N., Jose D., Lauren, Dave, Milo, Remy, Amanda, Doug, Ellison, Kali, Elizabeth", "notes": "Walk through ceremony and room flip. Jeanne arrives at 1pm. Antonia arrives at 1pm to set up banners/decor. Khristian drops off plants. Give Jeanne all items for next day." },
